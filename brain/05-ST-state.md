...
- Hooks: block-dangerous-commands, protect-sensitive-files, auto-format, debug-scrubber, require-tests, focused-test-guard, env-drift, git-workflow-guard (opt-in), verify-done, context-recovery, brain-loader.
