---
name: write
description: Edit prose to sound human and strip AI tells. Use when writing, editing, or reviewing prose (docs, posts, emails, READMEs, PRDs) and the text should not read as machine-generated.
---
...
On EDIT, silently load [references/surface-rules.md](references/surface-rules.md) for the kill list, em-dash ban, hollow openers, hedge limit, transition ban, contraction requirement, sycophancy patterns, and adverb fixes.
...
1. Write your draft
2. Dispatch a subagent with the draft + [references/surface-rules.md](references/surface-rules.md)
3. Subagent edits and returns revision

For deep edits, also include [references/deep-craft.md](references/deep-craft.md).
